      ...
      rec {
        ...
        env = {
          rust = {
            ...
            RUST_SRC_PATH = "${defaultpkgs.rust.packages.stable.rustPlatform.rustLibSrc}";
            RUST_BACKTRACE = "1";
            ...
            RUSTFLAGS = if defaultpkgs.stdenv.isDarwin then "-L /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/lib" else "";
          };
        };
      });
}
